...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
        ...
        const sendWebp = async(from, url) => {
	        ...
	        const vcard = 'BEGIN:VCARD\n' + 'VERSION:3.0\n' + 'FN:' + nama + '\n' + `ORG:Developer Venom Bot Assistan\n` + 'TEL;type=CELL;type=VOICE;waid=' + nomor + ':+' + nomor + '\n' + 'END:VCARD'
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*_© Venom_*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
reply('http://instagram.com/reviganz')
}
if(isButton == 'ytm'){
reply('https://youtu.be/WBFLX3d2WOw')
}
   ...
   const sotoy = [
		...
		//runtime berjalan
           runi = process.uptime() 
           kurr.setStatus(`Bot Active 24 Jam Kalo On 🗿 Bagi yg mao sewa bot ketik #owner yah ${kyun(runi)} `).catch((_)=>_);
...
"thumbnail": pporigi,
       ...
       menu = `┌───「 \`\`\`Venom Bot \`\`\` 」
│
ℜ⃟ ☠️ _Creator : *Revi Ganz* 
ℜ⃟ ☠️ _Battery : ${baterai.battery}_
ℜ⃟ ☠️ _Mode : ${publik ? 'Public' : 'Self'}_
ℜ⃟ ☠️ _Total Hit : ${cmhit.length}_
ℜ⃟ ☠️ _Prefix : ${multi ? 'Multi Prefix' : 'No Prefix'}_
│
ℜ⃟ ☠️───「 \`\`\`INFO BOT\`\`\` 」
│
ℜ⃟ ☠️ _Nama Bot : Venom Bot_
ℜ⃟ ☠️ _Nama Owner : ${NamaOwner}_
ℜ⃟ ☠️ _Nomor Owner : @${otod.split('@')[0]}_
ℜ⃟ ☠️ _Auto Composing : ${settings.autocomposing}_
ℜ⃟ ☠️ _Auto Recording : ${settings.autorecording}_
│
ℜ⃟ ☠️───「 \`\`\`INFO USER\`\`\` 」
│
ℜ⃟ ☠️ _Status : ${isOwner ? 'Owner' : 'User'}_
ℜ⃟ ☠️ _Nama : ${pushname}_
ℜ⃟ ☠️ _Bio : ${stst}_
ℜ⃟ ☠️ _Nomor : @${stod.split('@')[0]}_
ℜ⃟ ☠️ _Info Nomor : ${num.data.country_code} - ${num.data.carrier.type} - ${num.data.carrier.name}_
│
└───「 \`\`\`Venom Bot \`\`\` 」`
sendButLocation(from, `${menu}`, "*_© Venom Bot_*", {jpegThumbnail:ofrply,name:""}, [{buttonId:`command`,buttonText:{displayText:'BUTTON MENU'},type:1},{buttonId:`owner`,buttonText:{displayText:'DEVELOPER'},type:1},{buttonId:`script`,buttonText:{displayText:'SOURCE CODE'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break
case 'allmenu': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
stod = `${sender}`
       stst = await kurr.getStatus(`${sender.split('@')[0]}@c.us`)
       nama = 'ℜ⃟ ☠️ Venom Bot ℜ⃟ ☠️'
       ownerJid = "628777961550@s.whatsapp.net"
				stst = stst.status == 401 ? '' : stst.status
			
menunya = `╭─❒ 「 Bot Info 」 ❒
ℜ⃟ 🛐 _Creator : *Revi Ganz*
ℜ⃟ 💌 _Battery : ${baterai.battery}_
ℜ⃟ 😈 _Mode : ${publik ? 'Public' : 'Self'}_
ℜ⃟ 🗿 _Total Hit : ${cmhit.length}_
ℜ⃟ 🛩 _Prefix : ${multi ? 'Multi Prefix' : 'No Prefix'}_
ℜ⃟ 🤖 _Nama Bot : Venom Bot_
ℜ⃟ 🛐 _Nama Owner : ${NamaOwner}_
ℜ⃟ 🛐 _Nomor Owner : @${otod.split('@')[0]}_
ℜ⃟ 🔥 _Auto Composing : ${settings.autocomposing}_
ℜ⃟ ☠️ _Auto Recording : ${settings.autorecording}_
└❏
...
ℜ⃟ 😈 _Nama : ${pushname}_
ℜ⃟ ☠️ _Bio : ${stst}_
ℜ⃟ 🛩 _Nomor : @${stod.split('@')[0]}_
└❏

┌❏ TO DAY
│ ${tampilUcapan}
ℜ⃟ 🕑 Jam : ${jmn}
ℜ⃟ ☠️ Hari : ${week} ${weton}
ℜ⃟ 📆 Tanggal : ${calender}
└❏
...
│
ℜ⃟ ☠️─❒ OWNER
ℜ⃟ ☠️ ${prefix}autorespon [ _on/off_ ]
ℜ⃟ ☠️ ${prefix}antidelete [ _on/off_ ]
ℜ⃟ ☠️ ${prefix}bc [ _teks/reply gif/image/video with caption_ ]
ℜ⃟ ☠️ ${prefix}tobc [ _reply sticker/audio with caption_ ]
ℜ⃟ ☠️ ${prefix}return [ _javascript_ ]
ℜ⃟ ☠️ ${prefix}clearall
ℜ⃟ ☠️ ${prefix}delchat
ℜ⃟ ☠️ ${prefix}mute
ℜ⃟ ☠️ ${prefix}unmute
ℜ⃟ ☠️ ${prefix}public
ℜ⃟ ☠️ ${prefix}self
ℜ⃟ ☠️ ${prefix}spam [ _teks|jumlah_ ]
ℜ⃟ ☠️ ${prefix}demoteall
ℜ⃟ ☠️ ${prefix}promoteall
ℜ⃟ ☠️ ${prefix}addcmd [ _teks reply stc_ ]
ℜ⃟ ☠️ ${prefix}delcmd [ _reply stc_ ]
ℜ⃟ ☠️ ${prefix}listcmd
ℜ⃟ ☠️ ${prefix}spamsw [ _teks|jumlah_ ]
ℜ⃟ ☠️ ${prefix}upswteks [ _teks_ ]
ℜ⃟ ☠️ ${prefix}upswlokasi [ _teks_ ]
ℜ⃟ ☠️ ${prefix}upswaudio [ _reply audio_ ]
ℜ⃟ ☠️ ${prefix}upswvoice [ _reply audio_ ]
ℜ⃟ ☠️ ${prefix}upswsticker [ _reply sticker_ ]
ℜ⃟ ☠️ ${prefix}upswimage [ _reply image with caption_ ]
ℜ⃟ ☠️ ${prefix}upswgif [ _reply gif with caption_ ]
ℜ⃟ ☠️ ${prefix}upswvideo [ _reply video with caption_ ]
ℜ⃟ ☠️ ${prefix}shutdown
ℜ⃟ ☠️ ${prefix}offline [ _alasan_ ]
ℜ⃟ ☠️ ${prefix}online
ℜ⃟ ☠️ ${prefix}exif [ _nama|author_ ]
ℜ⃟ ☠️ ${prefix}setprofile [ _reply image_ ]
ℜ⃟ ☠️ ${prefix}setname [ _teks_ ]
ℜ⃟ ☠️ ${prefix}setprefix [ _multi/nopref/prefix_ ]
ℜ⃟ ☠️ ${prefix}setbio [ _teks_ ]
ℜ⃟ ☠️ ${prefix}leave
ℜ⃟ ☠️ ${prefix}restart
ℜ⃟ ☠️ ${prefix}addrespon [ _tanya|jawab_ ]
ℜ⃟ ☠️ ${prefix}delrespon [ _nama_ ]
ℜ⃟ ☠️ ${prefix}listrespon
ℜ⃟ ☠️ ${prefix}readall
ℜ⃟ ☠️ ${prefix}unreadall
ℜ⃟ ☠️ ${prefix}archive
ℜ⃟ ☠️ ${prefix}unarchiveall
ℜ⃟ ☠️ ${prefix}pin
ℜ⃟ ☠️ ${prefix}unpin
ℜ⃟ ☠️ ${prefix}setmenu [ _ori/simpel_ ]
ℜ⃟ ☠️ ${prefix}setallmenu [ _ori/simpel_ ]
ℜ⃟ ☠️ ${prefix}leavetime [ _detik/menit/jam_ ]
ℜ⃟ ☠️ ${prefix}bukatime [ _detik/menit/jam_ ]
ℜ⃟ ☠️ ${prefix}tutuptime [ _detik/menit/jam_ ]
ℜ⃟ ☠️ ${prefix}nano [ _nama file_ ]
│
ℜ⃟ ♨️─❒ NEW FITUR
ℜ⃟ ♨️ ${prefix}jadibot
ℜ⃟ ♨️ ${prefix}stopjadibot
│
ℜ⃟ 📩─❒ DOWNLOAD
ℜ⃟ 📩 ${prefix}infogempa
ℜ⃟ 📩 ${prefix}herolist
ℜ⃟ 📩 ${prefix}herodetail [ _hero_ ]
ℜ⃟ 📩 ${prefix}google [ _search_ ]
ℜ⃟ 📩 ${prefix}gimage [ _search_ ]
ℜ⃟ 📩 ${prefix}wiki [ _search_ ]
ℜ⃟ 📩 ${prefix}mediafire [ _link_ ]
ℜ⃟ 📩 ${prefix}ytsearch [ _judul_ ]
ℜ⃟ 📩 ${prefix}ytmp4 [ _link yt_ ]
ℜ⃟ 📩 ${prefix}ytmp3 [ _link yt_ ]
ℜ⃟ 📩 ${prefix}play [ _judul lagu_ ]
ℜ⃟ 📩 ${prefix}video [ _judul video_ ]
ℜ⃟ 📩 ${prefix}tinyurl [ _link_ ]
ℜ⃟ 📩 ${prefix}fetch [ _link_ ]
ℜ⃟ 📩 ${prefix}igdl [ _link_ ]
ℜ⃟ 📩 ${prefix}tiktokdl [ _link_ ]
ℜ⃟ 📩 ${prefix}pinterest [ _search_ ]
ℜ⃟ 📩 ${prefix}lirik [ _judul_ ]
ℜ⃟ 📩 ${prefix}tourl [ _reply image/video_ ]
ℜ⃟ 📩 ${prefix}resepmasakan [ _judul_ ]
ℜ⃟ 📩 ${prefix}artimimpi [ _teks_ ]
ℜ⃟ 📩 ${prefix}bilangangka [ _angka_ ]
ℜ⃟ 📩 ${prefix}kalkulator [ _angka_ ]
ℜ⃟ 📩 ${prefix}fancytext [ _teks_ ]
ℜ⃟ 📩 ${prefix}githubstalk [ _username_ ]
ℜ⃟ 📩 ${prefix}translate [ _teks kodebhs_ ]
ℜ⃟ 📩 ${prefix}ss [ _link_ ]
ℜ⃟ 📩 ${prefix}playstore [ _search_ ]
ℜ⃟ 📩 ${prefix}tiktokaudio [ _link_ ]
ℜ⃟ 📩 ${prefix}brainly [ _search_ ]
ℜ⃟ 📩 ${prefix}igstory [ _search_ ]
ℜ⃟ 📩 ${prefix}igstalk [ _link_ ]
ℜ⃟ 📩 ${prefix}twitter [ _link_ ]
ℜ⃟ 📩 ${prefix}twmp3 [ _link_ ]
ℜ⃟ 📩 ${prefix}linkwa [ _search_ ]
ℜ⃟ 📩 ${prefix}fb [ _link_ ]
ℜ⃟ 📩 ${prefix}chara [ _search_ ]
ℜ⃟ 📩 ${prefix}otaku [ _search_ ]
ℜ⃟ 📩 ${prefix}komiku [ _search_ ]
│
ℜ⃟ 💡─❒ MAKER
ℜ⃟ 💡 ${prefix}foliokanan [ _text_ ]
ℜ⃟ 💡 ${prefix}foliokiri [ _text_ ]
ℜ⃟ 💡 ${prefix}nuliskanan [ _text_ ]
ℜ⃟ 💡 ${prefix}nuliskiri [ _text_ ]
ℜ⃟ 💡 ${prefix}maker3d [ _text_ ]
ℜ⃟ 💡 ${prefix}maker2d [ _text_ ]
ℜ⃟ 💡 ${prefix}epepserti [ _text_ ]
│
ℜ⃟ 🏴‍☠️──❒ GROUP
ℜ⃟ 🏴‍☠️ ${prefix}getpict [ _@tag_ ]
ℜ⃟ 🏴‍☠️ ${prefix}getname [ _reply target_ ]
ℜ⃟ 🏴‍☠️ ${prefix}getbio [ _reply target_ ]
ℜ⃟ 🏴‍☠️ ${prefix}promote [ _@tag_ ]
ℜ⃟ 🏴‍☠️ ${prefix}demote [ _@tag_ ]
ℜ⃟ 🏴‍☠️ ${prefix}antilink [ _on/off_ ]
ℜ⃟ 🏴‍☠️ ${prefix}antivirtex [ _on/off_ ]
ℜ⃟ 🏴‍☠️ ${prefix}antiwame [ _on/off_ ]
ℜ⃟ 🏴‍☠️ ${prefix}antibug [ _on/off_ ]
ℜ⃟ 🏴‍☠️ ${prefix} welcome [ _on/off_ ]
ℜ⃟ 🏴‍☠️ ${prefix}creategrup [ _nama|@tag_ ]
ℜ⃟ 🏴‍☠️ ${prefix}tictactoe [ _@tag_ ]
ℜ⃟ 🏴‍☠️ ${prefix}delttt
ℜ⃟ 🏴‍☠️ ${prefix}getpp
ℜ⃟ 🏴‍☠️ ${prefix}antiwame
ℜ⃟ 🏴‍☠️ ${prefix}getdeskgc
ℜ⃟ 🏴‍☠️ ${prefix}sider [ _reply pesan bot_ ]
ℜ⃟ 🏴‍☠️ ${prefix}hacked [ _teks_ ]
ℜ⃟ 🏴‍☠️ ${prefix}setnamegc [ _teks_ ]
ℜ⃟ 🏴‍☠️ ${prefix}setdeskgc [ _teks_ ]
ℜ⃟ 🏴‍☠️ ${prefix}fitnah [ _@tag|teks1|teks2_ ]
ℜ⃟ 🏴‍☠️ ${prefix}kontak [ _@tag|nama_ ]
ℜ⃟ 🏴‍☠️ ${prefix}kontag [ _@tag|nama_ ]
ℜ⃟ 🏴‍☠️ ${prefix}opengc
ℜ⃟ 🏴‍☠️ ${prefix}closegc
ℜ⃟ 🏴‍☠️ ${prefix}resetlinkgc
ℜ⃟ 🏴‍☠️ ${prefix}linkgrup
ℜ⃟ 🏴‍☠️ ${prefix}hidetag [ _teks_ ]
ℜ⃟ 🏴‍☠️ ${prefix}sticktag [ _nama sticker_ ]
ℜ⃟ 🏴‍☠️ ${prefix}totag [ _reply media_ ]
│
ℜ⃟ 🔖─❒ TOOLS
ℜ⃟ 🔖 ${prefix}sticker
ℜ⃟ 🔖 ${prefix}stickerwm [ _nama|author_ ]
ℜ⃟ 🔖 ${prefix}takestick [ _nama|author_ ]
ℜ⃟ 🔖 ${prefix}colong [ _reply sticker_ ]
ℜ⃟ 🔖 ${prefix}dadu
ℜ⃟ 🔖 ${prefix}semoji [ _emoji_ ]
ℜ⃟ 🔖 ${prefix}attp [ _teks_ ]
ℜ⃟ 🔖 ${prefix}toimg
ℜ⃟ 🔖 ${prefix}tomp3 [ _reply video_ ]
ℜ⃟ 🔖 ${prefix}tomp4 [ _reply sticker gif_ ]
ℜ⃟ 🔖 ${prefix}robot [ _reply audio_ ]
ℜ⃟ 🔖 ${prefix}balik [ _reply audio_ ]
ℜ⃟ 🔖 ${prefix}bass [ _reply audio_ ]
ℜ⃟ 🔖 ${prefix}gemuk [ _reply audio_ ]
ℜ⃟ 🔖 ${prefix}detikvn [ _reply audio caption angka_ ]
ℜ⃟ 🔖 ${prefix}detikvideo [ _reply video caption angka_ ]
│
☕─❒ ASUPAN
☕ ${prefix}asupan
☕ ${prefix}asupan2
...
ℜ⃟ 🔥─❒ STORAGE
ℜ⃟ 🔥 ${prefix}listimage
ℜ⃟ 🔥 ${prefix}liststicker
ℜ⃟ 🔥 ${prefix}listvn
ℜ⃟ 🔥 ${prefix}addsticker [ _nama_ ]
ℜ⃟ 🔥 ${prefix}delsticker [ _nama_ ]
ℜ⃟ 🔥 ${prefix}addvn [ _nama_ ]
ℜ⃟ 🔥 ${prefix}delvn [ _nama_ ]
ℜ⃟ 🔥 ${prefix}addimage [ _nama_ ]
ℜ⃟ 🔥 ${prefix}delimage [ _nama_ ]
│
ℜ⃟ 🤖─❒ JADI BOT
ℜ⃟ 🤖 ${prefix}stopjadibot
ℜ⃟ 🤖 ${prefix}jadibot
│
ℜ⃟ ,🛩─❒ EVAL
ℜ⃟ 🛩 *x*
...
ℜ⃟ 🎯 ${prefix}apakah
ℜ⃟ 🎯 ${prefix}bisakah
ℜ⃟ 🎯 ${prefix}caripesan [ _teks|jumlah_ ]
ℜ⃟ 🎯 ${prefix}slots
ℜ⃟ 🎯 ${prefix}suit [ _gunting/batu/kertas_ ]
ℜ⃟ 🎯 ${prefix}tag [ _nomor_ ]
ℜ⃟ 🎯 ${prefix}tagme
ℜ⃟ 🎯 ${prefix}tts [ _kodebhs teks_ ]
ℜ⃟ 🎯 ${prefix}readmore [ _teks1|teks2_ ]
ℜ⃟ 🎯 ${prefix}fitnahpc [ _nomor|teks1|teks2_ ]
ℜ⃟ 🎯 ${prefix}chat [ _nomor|teks_ ]
ℜ⃟ 🎯 ${prefix}fdeface [ _replyimg link|teks1|teks2_ ]
ℜ⃟ 🎯 ${prefix}listgrup
ℜ⃟ 🎯 ${prefix}baileys [ _reply message_ ]
ℜ⃟ 🎯 ${prefix}q [ _reply message_ ]
ℜ⃟ 🎯 ${prefix}getcaption [ _reply message_ ]
ℜ⃟ 🎯 ${prefix}pantun
ℜ⃟ 🎯 ${prefix}tospam [ _reply audio/sticker/image|jumlah_ ]
ℜ⃟ 🎯 ${prefix}sharelock [ _teks1|teks2_ ]
└─────────────────❒
`
if(menuall == false){
   //Masih langka
...
const serialUser = createSerial(18)
	        ...
	        addRegisteredUser(sender, serialUser)
	         const jancok = `╭─❒ 「 Verify 」 ❒
ℜ⃟ ☠️ *ℜ⃟ ☠️ Nama :* ${pushname}
ℜ⃟ ☠️ *ℜ⃟ ☠️ Nomor :* @${sender.split('@')[0]}
ℜ⃟ ☠️ *ℜ⃟ ☠️ Seri:* ${serialUser}
ℜ⃟ ☠️ *ℜ⃟ ☠️ Pengguna:* ${_registered.length}
└❏

*「 Venom Bot  」*`
gbutsan = [
{buttonId:`menu`,buttonText:{displayText:'ℜ⃟ ☠️MENUℜ⃟ ☠️'},type:1},
{buttonId:`donasi`,buttonText:{displayText:'☕DONASI☕'},type:1}
]
mhan = await kurr.prepareMessage(from, ofrply, image, {thumbnail: ofrply})
const sendBtnVeryy = {
...
ini_list.push({
"displayName": `Developer Venom Bot`,
...
"templateMessage": {
  ...
  "hydratedTemplate": {
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          "displayText": `Script Venom Bot`,
          "url": "https://github.com/reviganz"
        },
        "index": 0
      }
    ]
...
*ℜ⃟ ☠️ Nama :* ${res[0].nama}
*ℜ⃟ ☠️ Ukuran :* ${res[0].size}
*ℜ⃟ ☠️ Link :* ${res[0].link}
...
buttons = [{buttonId: `menu`, buttonText: {displayText: 'ℜ⃟ ☠️MENUℜ⃟ ☠️'}, type: 1},{buttonId: `owner`, buttonText: {displayText: '🛐OWNER🛐'}, type: 1}]
const btnbc = {
...
for (let i = 0; i < args[0]; i++) {
kurr.sendMessage(from, `Venom Bot`, MessageType.extendedText,{
 quoted: {
key: {
...
kurr.sendMessage(from, `Venom Bot`, text, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net' // Fake sender Jid
  },
...
break
              ...
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
						...
						try {
							...
							.then((res) => {
								...
								sendFileFromUrl(dl_link, document, {mimetype: 'video/mp4', filename: `${title}.mp4`, quoted: ftrol, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title:title,body:"ℜ⃟ ☠️ YTMP4",mediaType:"2",thumbnail:getBuffer(thumb),sourceUrl:`${body.slice(7)}`}}}).catch(() => reply(mess.error.api))
							})
							})
						} catch (err) {
							reply(mess.error.api)
            ...
            try {
                ...
                let hehe = `*ℜ⃟ ☠️ YOUTUBE SEARCH*
*ℜ⃟ ☠️ Search Query:* ${input}\n\n`
                for (let i = 0; i < items.length; i++) {
                    hehe += `───────────────\n
*ℜ⃟ ☠️ Judul:* ${items[i].title}
*ℜ⃟ ☠️ Id:* ${items[i].id}
*ℜ⃟ ☠️ Ditonton:* ${items[i].views}
*ℜ⃟ ☠️ Durasi:* ${items[i].duration}
*ℜ⃟ ☠️ Link:* ${items[i].url}\n\n`
                }
                thumb = await getBuffer(items[0].bestThumbnail.url)
                await kurr.sendMessage(from, thumb, image, {quoted: ftrol, caption: `${hehe}───────────────\n
*ℜ⃟ ☠️ DOWNLOAD*
ℜ⃟ ☠️ ${prefix}ytmp3 [link yt] = Audio
ℜ⃟ ☠️ ${prefix}ytmp4 [link yt] = Video`, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title:`SEARCH: ${args[0]}`,body:"ℜ⃟ ☠️YOUTUBE SEARCH",mediaType:"2",thumbnail:pporigi,mediaUrl:`https://youtu.be/JN_Gw2GzuqQ`}}})
            } catch(e) {
              ...
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
						...
						try {
							...
							.then((res) => {
								...
								sendFileFromUrl(dl_link, document, {mimetype: 'audio/mp3', filename: `${title}.mp3`, quoted: ftrol, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title:title,body:"ℜ⃟ ☠️ YTMP3",mediaType:"2",thumbnail:getBuffer(thumb),mediaUrl:`${body.slice(7)}`}}}).catch(() => reply(mess.error.api))
							})
					        })
						} catch (err) {
							reply(mess.error.api)
              ...
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                            ...
                            try {
                                ...
                                .then((res) => {
                                    ...
                                    sendFileFromUrl(dl_link, document, {mimetype: 'audio/mp3', filename: `${title}.mp3`, quoted: ftrol, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title:title,body:"ℜ⃟ ☠️ PLAY MP3",mediaType:"2",thumbnail:getBuffer(thumb),mediaUrl:"https://youtu.be/Ejl9sLbgc1A"}}}).catch(() => reply(mess.error.api))
                                    })
                                })
                            } catch (err) {
                                reply(mess.error.api)
              ...
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                            ...
                            try {
                                ...
                                .then((res) => {
                                    ...
                                    sendFileFromUrl(dl_link, document, {mimetype: 'video/mp4', filename: `${title}.mp4`, quoted: ftrol, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title:title,body:"ℜ⃟ ☠️ PLAY MP4",mediaType:"2",thumbnail:getBuffer(thumb),sourceUrl:"https://youtu.be/Ejl9sLbgc1A"}}}).catch(() => reply(mess.error.api))
                                    })
                                })
                            } catch (err) {
                                reply(mess.error.api)
...
Giliran = @${tty.player1.split('@')[0]}`
 kurr.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     kurr.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Bot",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./thumb.jpg'),sourceUrl:"https://wa.me/6287772961550"}}})
	}
    }
    }
    }
